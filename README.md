# Finnhub Real-time Streaming Data Pipeline

The project is a streaming data pipeline based on Finnhub.io API/websocket real-time trading data created for a sake of master's thesis related to stream processing.
